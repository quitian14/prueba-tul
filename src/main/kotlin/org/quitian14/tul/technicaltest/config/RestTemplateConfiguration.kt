...
import org.quitian14.tul.technicaltest.handlers.RestTemplateResponseErrorHandler
...
class RestTemplateConfiguration {
    ...
    private fun getRestTemplate(connectionTimeOut: Int, readTimeout: Int, connectionRequestTimeout: Int): RestTemplate {
        ...
        val restTemplate =
            RestTemplate(clientHttpRequestFactory(connectionTimeOut, readTimeout, connectionRequestTimeout))
